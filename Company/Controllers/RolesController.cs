...
namespace Company.Controllers
{
    public class RolesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoleID,Department,Position")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoleID,Department,Position")] Role role)
        {
            if (id != role.RoleID)
            {
                return NotFound();
